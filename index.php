...
<!--            
            <div class="input-group mx-auto text-center" style="max-width:450px;">
                ...
                <div class="input-group-append">
                    ...
                    <button type="button" id="msisdn_decode_jsonrpc" class="btn btn-secondary">Decode over JsonRPC</button>
                </div>
            </div>
-->
            <div class="row">
                <div class="col-lg-offset-3 col-lg-6 mx-auto text-center" style="max-width:450px;">
                    <div class="input-group">
                        <span class="input-group-btn">
                            <button id="ajaxrpc" type="button" name="msisdn" class="btn btn-secondary">Ajax RPC</button>
                        </span>
